...
CREATE TABLE `all_medicine` (
	...
	`medicine_description` varchar(150) NOT NULL,
...
CREATE TABLE `medicine` (
    ...
    CONSTRAINT `medicine_fk0` FOREIGN KEY (`pharmacy_id`) REFERENCES `pharmacy`(`pharmacy_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
